    ...
    <div class="row-fluid">
        <div class="span12">
            <ul class="dshb_icoNav tac">
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/multi-agents.png)"><span class="label label-info">+10</span> Users</a></li>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/world.png)">Map</a></li>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/configuration.png)">Settings</a></li>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/lab.png)">Lab</a>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/van.png)"><span class="label label-success">$2851</span> Delivery</a></li>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/pie-chart.png)">Charts</a></li>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/edit.png)">Add New Article</a></li>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/add-item.png)"> Add New Page</a></li>
                <li><a href="javascript:void(0)" style="background-image: url(resources/template/geboadmin/img/gCons/chat-.png)"><span class="label label-important">26</span> Comments</a></li>
            </ul>
        </div>
    </div>
    <div class="row-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="span6">
            ...
            <div id="small_grid" class="wmk_grid">
                <ul>
                    <li class="thumbnail">
                        <a title="Image_4 title long title long title long" href="resources/template/geboadmin/gallery/Image04.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image04_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_5 title long title long title long" href="resources/template/geboadmin/gallery/Image05.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image05_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_6 title long title long title long" href="resources/template/geboadmin/gallery/Image06.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image06_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_7 title long title long title long" href="resources/template/geboadmin/gallery/Image07.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image07_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_8 title long title long title long" href="resources/template/geboadmin/gallery/Image08.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image08_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_9 title long title long title long" href="resources/template/geboadmin/gallery/Image09.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image09_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_10 title long title long title long" href="resources/template/geboadmin/gallery/Image10.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image10_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_11 title long title long title long" href="resources/template/geboadmin/gallery/Image11.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image11_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_12 title long title long title long" href="resources/template/geboadmin/gallery/Image12.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image12_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_13 title long title long title long" href="resources/template/geboadmin/gallery/Image13.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image13_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_14 title long title long title long" href="resources/template/geboadmin/gallery/Image14.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image14_tn.jpg">
                        </a>
                        <p>
                    ...
                    <li class="thumbnail">
                        <a title="Image_15 title long title long title long" href="resources/template/geboadmin/gallery/Image15.jpg">
                            <img alt="" src="resources/template/geboadmin/gallery/Image15_tn.jpg">
                        </a>
                        <p>
